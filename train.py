...
CONFIG = {
    ...
    'architecture_name': 'graph_transformer_gat_v1_residual_futuremet',  # GraphTransformer + GATv1 + persistence residual + oracle future meteorology
...
def train(config, trial=None):
    ...
    # Create dataloaders with scaled data (Z included when future_met is enabled)
    train_loader, val_loader, test_loader = create_dataloaders(
        (X_train_scaled, Y_train_scaled, Z_train_scaled),
        (X_val_scaled,   Y_val_scaled,   Z_val_scaled),
        (X_test_scaled,  Y_test_scaled,  Z_test_scaled),
        config
    )
