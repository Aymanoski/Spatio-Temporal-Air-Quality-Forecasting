...
CONFIG = {
    ...
    'architecture_name': 'graph_transformer_gat_v1_residual_log1p_all_std_delta',  # GraphTransformer + GATv1 + persistence residual + log1p + StandardScaler
...
def load_data(config):
    ...
    suffix = '_delta' if config.get('use_pm25_delta', False) else ''
...
def train(config, trial=None):
    ...
    # When PM2.5 delta is inserted at index 17, wind one-hot shifts by one.
